...
var errHeaderTooShort, errMissingAddress, errBufferTooShort error
func init(){
	errHeaderTooShort = errors.New("oh errHeaderTooShort")
	errMissingAddress = errors.New("oh errMissingAddress")
	errBufferTooShort = errors.New("oh errBufferTooShort")
}
